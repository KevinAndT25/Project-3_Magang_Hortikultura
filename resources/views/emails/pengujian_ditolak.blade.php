...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #c0392b 0%, #e74c3c 100%); padding: 25px 30px; text-align: center; }
        ...
        .body .highlight { background: #fce4ec; padding: 15px 20px; border-radius: 8px; border-left: 4px solid #e74c3c; margin: 15px 0; }
        .body .highlight strong { color: #c0392b; }
        .body .status-badge { display: inline-block; background: #e74c3c; color: white; padding: 4px 16px; border-radius: 20px; font-weight: 600; font-size: 14px; }
        .btn { display: inline-block; background: #e74c3c; color: white; padding: 12px 30px; border-radius: 8px; text-decoration: none; font-weight: 600; margin-top: 15px; }
    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <div class="highlight">
                ...
                <p style="margin: 5px 0 0 0; font-size: 14px;">
                    <strong>Tanggal Penolakan:</strong> {{ now()->format('d M Y H:i') }}
                </p>
            </div>
            ...
            <p>
                <strong>Status:</strong> Permohonan <strong>berakhir</strong> di tahap pengujian dan statusnya telah berubah menjadi 
                <strong>"Selesai"</strong>.
            </p>
            
            <p style="color: #c0392b; font-weight: 500;">
                <i class="bi bi-info-circle"></i> 
                Permohonan ini tidak dapat melanjutkan ke tahap Test Report dan Kuisioner.
            </p>
            
            <p>Silakan login ke sistem untuk melihat detail permohonan.</p>
