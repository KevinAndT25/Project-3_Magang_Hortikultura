...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <div class="highlight">
                <p style="margin: 0;">
                    Ada permohonan baru dari <strong>{{ $permohonan->nama_pemohon ?? 'Pemohon' }}</strong>
                </p>
                ...
                <p style="margin: 5px 0 0 0; font-size: 14px;">
                    <strong>Tanggal:</strong> {{ $permohonan->created_at->format('d M Y H:i') }}
                </p>
            </div>
            <p>Silakan login ke sistem untuk melakukan validasi permohonan ini.</p>
