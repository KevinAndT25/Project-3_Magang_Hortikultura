...
<head>
    ...
    <title>Test Report Selesai</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <div class="highlight">
                <p style="margin: 0;">
                    Test Report untuk permohonan Anda 
                    <strong>{{ $permohonan->nomor_surat_permohonan ?? 'PMH-'.str_pad($permohonan->id, 6, '0', STR_PAD_LEFT) }}</strong>
                    telah <strong>selesai</strong> dan dapat diunduh.
                </p>
                <p style="margin: 5px 0 0 0; font-size: 14px;">
                    <strong>Jenis Alsintan:</strong> {{ $permohonan->jenis_alsintan }}
                </p>
                <p style="margin: 5px 0 0 0; font-size: 14px;">
                    <strong>Tanggal Selesai:</strong> {{ now()->format('d M Y H:i') }}
                </p>
            </div>
            <p>Silakan login ke sistem untuk mengunduh Test Report dan mengisi Kuisioner Kepuasan.</p>
