        ...
        <div class="body">
            ...
            <div class="highlight">
                <p style="margin: 0;">
                    ...
                    telah <strong>selesai diuji</strong> oleh admin.
                </p>
                <p style="margin: 5px 0 0 0; font-size: 14px;">
                    <strong>Jenis Alsintan:</strong> {{ $permohonan->jenis_alsintan }}
                </p>
                <p style="margin: 5px 0 0 0; font-size: 14px;">
                    <strong>Tanggal Pengujian:</strong> {{ now()->format('d M Y H:i') }}
                </p>
            </div>
            <p>Silakan login ke sistem untuk melihat hasil pengujian dan melanjutkan ke tahap Test Report.</p>
